...
import { deleteEventAction } from "../../../redux/actions/EventAction";
function EventTableOption({ data }) {
  ...
  return (
    <div>
      <div className="flex gap-2">
        <span
          onClick={() => ConfirmDelete(dispatch, deleteEventAction, data._id)}
...
export default EventTableOption;
